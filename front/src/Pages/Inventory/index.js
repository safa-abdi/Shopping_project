...
function Inventory() {
  ...
  async function getEcrivain(){
    let result = await fetch("http://localhost:3000/api/SelectEcrivain"); 
    result = await result.json();
    setData(result)


   }
   async function searchEcrivain(key){
    console.warn(key)
    let result = await fetch('http://localhost:3000/searchEcrivain/'+key);
    result= await result.json();
    console.warn(result)
   setData(result)
   
}
   async function deleteEcrivain(_id){
    if(window.confirm("êtes-vous sûr de  supprimer cette client")){
    let result = await fetch('http://localhost:3000/api/suppEcrivain/'+_id , {
      method: 'DELETE'
    });
    result = await result.json();
    console.log(result)
  ...
  return (
    ...
    <section className="py-1 bg-blueGray-50 pr-10 lg:pr-0">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u>Liste des Ecrivains</u></b></h1><br /><br/>
            ...
            <div className="lg:flex items-center">
              <div className="relative w-full px-4 max-w-full flex">
                ...
                &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp; <b className="re">Rechercher</b><input type="text" placeholder="      Rechercher" className="search"
                                    onChange={(e)=>searchEcrivain(e.target.value)}         />
                </div>
              </div>
              ...
              <tbody className="heads"> {
                                data.map((item) => (
                                    <tr >
                                        ...
                                        <span onClick={() =>deleteEcrivain(item._id)} ><figure>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
